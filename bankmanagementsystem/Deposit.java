...
amount.addKeyListener(new KeyAdapter() {
    public void keyPressed(KeyEvent e) {
       ...
       if (ae.getSource()== b1){
          ...
          if (number.equals("")) {
          JOptionPane.showMessageDialog(null, "Please enter a valid amount that you want to deposit");
          } else {
          try {
           Conn conn = new Conn();
           String query = "insert into bank values('"+pin+"','"+ formattedDate +"','Deposit','"+number+"')";
